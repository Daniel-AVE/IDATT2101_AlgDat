            ...
            switch (choice) {
                case 1 -> {
                    ...
                    while (!finished) {
                        ...
                        Node root = Huffman.huffman(frequencies);                //Oving8.Huffman with the array of frequencies
                ...
                case 2 -> {
                    ...
                    while (!finished) {
                        System.out.println("""
                                ...
                                5. enwik8Comp.txt (WARNING: This will take a long time)
                        ...
                        switch (choice) {
                            ...
                            case 5 -> {
                                ...
                                input2 = output1;
                                output2 = "./enwik8DecompFinished.txt";
                                original = "./enwik8";
                            }
                            case 6 -> {
                                System.out.println("Back to main menu");
...
class Huffman
{
    ...
    public static Node huffman(int[] C) {						//Implementation of huffman
        PQ Q = new PQHeap(C.length);							//lag instance av Oving8.PQ Heap
...
// Oving8.Node for å representere koblinger i treet.
class Node {
...
class PQHeap implements PQ {
    ...
    // Opretter et nytt Array av Oving8.Element.
