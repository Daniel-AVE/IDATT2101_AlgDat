...
class Exercise3a {
    ...
    public static void calculate(String[] input) {
        ...
        LinkedList list1 = createListFromString(input[0], maxLength);
        LinkedList list2 = createListFromString(input[2], maxLength);
    ...
    public static LinkedList createListFromString(String input, int length) {
    ...
    public static int calc(LinkedList list, String operator, int first, int last, int rest) {
        if (operator.equals("+")) {
