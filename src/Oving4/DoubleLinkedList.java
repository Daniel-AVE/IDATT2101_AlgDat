...
class longIntegerArithmetic {
    ...
    public static DoubleLinkedList dLinkedList1 = new DoubleLinkedList();
    public static DoubleLinkedList dLinkedList2 = new DoubleLinkedList();
    public static StringBuilder answer = new StringBuilder("");
    public static DoubleLinkedList answer_dLinkedList = new DoubleLinkedList();
    ...
    public static void calculateExpression(){
        ...
        DoubleLinkedList.Node current_element1 = dLinkedList1.head;
        DoubleLinkedList.Node current_element2 = dLinkedList2.head;
        ...
        DoubleLinkedList.Node current_ans_e = answer_dLinkedList.tail;
    ...
    public static void subtractNumbers(){
        DoubleLinkedList.Node current_e1;
        DoubleLinkedList.Node current_e2;
        ...
        if(isGreaterThan(dLinkedList2, dLinkedList1) == 1 && neg == false){
            neg = true;
            DoubleLinkedList dl1 = dLinkedList1;
    ...
    public static int isGreaterThan(DoubleLinkedList a, DoubleLinkedList b){
        DoubleLinkedList.Node current_a = a.head;
        DoubleLinkedList.Node current_b = b.head;
    ...
    public static int sumNumbers(){
        DoubleLinkedList.Node current_e1 = dLinkedList1.tail;
        DoubleLinkedList.Node current_e2 = dLinkedList2.tail;
        DoubleLinkedList.Node current_ans_e = answer_dLinkedList.tail;

        if(neg){
            DoubleLinkedList dLink1 = dLinkedList1;
            DoubleLinkedList dLink2 = dLinkedList2;
